...
Instance.sound_assets.update([
    Asset(1840002, f"{sound_url}/mus_mg_201303_cjsnow_gamewindamb.mp3", "mus_mg_201303_cjsnow_gamewindamb"),
    Asset(1840003, f"{sound_url}/sfx_mg_2013_cjsnow_snowmantankhit.mp3", "sfx_mg_2013_cjsnow_snowmantankhit"),
    Asset(1840004, f"{sound_url}/sfx_mg_2013_cjsnow_snowmanslyhit.mp3", "sfx_mg_2013_cjsnow_snowmanslyhit"),
    Asset(1840005, f"{sound_url}/sfx_mg_2013_cjsnow_snowmanscraphit.mp3", "sfx_mg_2013_cjsnow_snowmanscraphit"),
    Asset(1840006, f"{sound_url}/sfx_mg_2013_cjsnow_snowmandeathexplode.mp3", "sfx_mg_2013_cjsnow_snowmandeathexplode"),
    Asset(1840007, f"{sound_url}/sfx_mg_2013_cjsnow_penguininground.mp3", "sfx_mg_2013_cjsnow_penguinground"),
    Asset(1840008, f"{sound_url}/sfx_mg_2013_cjsnow_penguinhitsuccess.mp3", "sfx_mg_2013_cjsnow_penguinhitsuccess"),
    Asset(1840009, f"{sound_url}/sfx_mg_2013_cjsnow_snowmenappear.mp3", "sfx_mg_2013_cjsnow_snowmenappear"),
    Asset(1840010, f"{sound_url}/sfx_mg_2013_cjsnow_impactsly.mp3", "sfx_mg_2013_cjsnow_impactsly"),
    Asset(1840011, f"{sound_url}/sfx_mg_2013_cjsnow_impactscrap.mp3", "sfx_mg_2013_cjsnow_impactscrap"),
    Asset(1840012, f"{sound_url}/sfx_mg_2013_cjsnow_impactpowercardsnow.mp3", "sfx_mg_2013_cjsnow_impactpowercardsnow"),
    Asset(1840013, f"{sound_url}/sfx_mg_2013_cjsnow_footsteptank.mp3", "sfx_mg_2013_cjsnow_footsteptank"),
    Asset(1840014, f"{sound_url}/sfx_mg_2013_cjsnow_footstepsly_loop.mp3", "sfx_mg_2013_cjsnow_footstepsly_loop"),
    Asset(1840015, f"{sound_url}/sfx_mg_2013_cjsnow_footstepscrap_loop.mp3", "sfx_mg_2013_cjsnow_footstepscrap_loop"),
    Asset(1840016, f"{sound_url}/sfx_mg_2013_cjsnow_footsteppenguinfire.mp3", "sfx_mg_2013_cjsnow_footsteppenguinfire"),
    Asset(1840017, f"{sound_url}/sfx_mg_2013_cjsnow_footsteppenguin.mp3", "sfx_mg_2013_cjsnow_footsteppenguin"),
    Asset(1840018, f"{sound_url}/sfx_mg_2013_cjsnow_attackwater.mp3", "sfx_mg_2013_cjsnow_attackwater"),
    Asset(1840019, f"{sound_url}/sfx_mg_2013_cjsnow_attacktank.mp3", "sfx_mg_2013_cjsnow_attacktank"),
    Asset(1840020, f"{sound_url}/sfx_mg_2013_cjsnow_attacksnow.mp3", "sfx_mg_2013_cjsnow_attacksnow"),
    Asset(1840021, f"{sound_url}/sfx_mg_2013_cjsnow_attacksly.mp3", "sfx_mg_2013_cjsnow_attacksly"),
    Asset(1840022, f"{sound_url}/sfx_mg_2013_cjsnow_attackscrap.mp3", "sfx_mg_2013_cjsnow_attackscrap"),
    Asset(1840023, f"{sound_url}/sfx_mg_2013_cjsnow_attackpowercardwater.mp3", "sfx_mg_2013_cjsnow_attackpowercardwater"),
    Asset(1840024, f"{sound_url}/sfx_mg_2013_cjsnow_attackpowercardsnow.mp3", "sfx_mg_2013_cjsnow_attackpowercardsnow"),
    Asset(1840025, f"{sound_url}/sfx_mg_2013_cjsnow_attackpowercardfire.mp3", "sfx_mg_2013_cjsnow_attackpowercardfire"),
    Asset(1840026, f"{sound_url}/sfx_mg_2013_cjsnow_attackfire.mp3", "sfx_mg_2013_cjsnow_attackfire"),
    Asset(1840028, f"{sound_url}/sfx_mg_2013_cjsnow_tusklaugh.mp3", "sfx_mg_2013_cjsnow_tusklaugh"),
    Asset(1840029, f"{sound_url}/sfx_mg_2013_cjsnow_impactsenseisnow.mp3", "sfx_mg_2013_cjsnow_impactsenseisnow"),
    Asset(1840030, f"{sound_url}/sfx_mg_2013_cjsnow_hittusk.mp3", "sfx_mg_2013_cjsnow_hittusk"),
    Asset(1840031, f"{sound_url}/sfx_mg_2013_cjsnow_hitsensei.mp3", "sfx_mg_2013_cjsnow_hitsensei"),
    Asset(1840032, f"{sound_url}/sfx_mg_2013_cjsnow_attacktuskicicle02.mp3", "sfx_mg_2013_cjsnow_attacktuskicicle02"),
    Asset(1840033, f"{sound_url}/sfx_mg_2013_cjsnow_attacktuskicicle01.mp3", "sfx_mg_2013_cjsnow_attacktuskicicle01"),
    Asset(1840034, f"{sound_url}/sfx_mg_2013_cjsnow_attacktuskearthquake.mp3", "sfx_mg_2013_cjsnow_attacktuskearthquake"),
    Asset(1840035, f"{sound_url}/sfx_mg_2013_cjsnow_attacksenseiwater.mp3", "sfx_mg_2013_cjsnow_attacksenseiwater"),
    Asset(1840036, f"{sound_url}/sfx_mg_2013_cjsnow_attacksenseisnow.mp3", "sfx_mg_2013_cjsnow_attacksenseisnow"),
    Asset(1840037, f"{sound_url}/sfx_mg_2013_cjsnow_attacksenseifire.mp3", "sfx_mg_2013_cjsnow_attacksenseifire"),
    Asset(1840038, f"{sound_url}/sfx_mg_2013_cjsnow_uitargetselect.mp3", "sfx_mg_2013_cjsnow_uitargetselect"),
    Asset(1840039, f"{sound_url}/sfx_mg_2013_cjsnow_uitargetred.mp3", "sfx_mg_2013_cjsnow_uitargetred"),
    Asset(1840040, f"{sound_url}/sfx_mg_2013_cjsnow_uiselecttile.mp3", "sfx_mg_2013_cjsnow_uiselecttile"),
    Asset(1840041, f"{sound_url}/mus_mg_201303_cjsnow_tuskthemecaveamb.mp3", "mus_mg_201303_cjsnow_tuskthemecaveamb"),
    Asset(1840042, f"{sound_url}/sfx_mg_2013_cjsnow_uiplayerready_vbr8.mp3", "SFX_MG_2013_CJSnow_UIPlayerReady_VBR8"),
    Asset(1840043, f"{sound_url}/SFX_MG_CJSnow_PowercardReviveStart.mp3", "SFX_MG_CJSnow_PowercardReviveStart"),
    Asset(1840044, f"{sound_url}/SFX_MG_CJSnow_PowercardReviveEnd.mp3", "SFX_MG_CJSnow_PowercardReviveEnd"),
])
